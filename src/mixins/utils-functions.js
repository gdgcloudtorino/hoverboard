/* @polymerMixin */
export const UtilsFunctions = (subclass) => class extends subclass {
  ...
  generateClassName(value) {
    return value ? value.replace(/\W+/g, '-').replace(/([a-z\d])([A-Z])/g, '$1-$2').toLowerCase() : '';
  }
  ...
  parseQueryParamsFilters(queryParams) {
    return queryParams.split('&')
        ...
        .reduce((aggr, filter) => Object.assign({}, aggr, {
