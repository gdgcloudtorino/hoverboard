...
export const FETCH_USER_FEATURED_SESSIONS_FAILURE = 'app/Sessions/FETCH_USER_FEATURED_SESSIONS_FAILURE';
export const FETCH_USER_FEATURED_SESSIONS_SUCCESS = 'app/Sessions/FETCH_USER_FEATURED_SESSIONS_SUCCESS';
